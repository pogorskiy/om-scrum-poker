...
Client -> server events: `join`, `vote`, `reveal`, `new_round`, `clear_room`, `update_name`, `presence`, `update_role`, `leave`, `timer_set_duration`, `timer_start`, `timer_reset`.
Server -> client events: `room_state`, `participant_joined`, `participant_left`, `vote_cast`, `vote_retracted`, `votes_revealed`, `round_reset`, `room_cleared`, `presence_changed`, `name_updated`, `role_updated`, `timer_updated`, `error`.
